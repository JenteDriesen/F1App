...
export default function Navbar() {
    ...
    return (
        <nav className="fixed top-0 left-0 right-0 z-[2000] flex items-center gap-4 px-6 h-16 bg-zinc-100/90 dark:bg-zinc-900/90 backdrop-blur-sm border-b-8 border-double border-red-600">
