        ...
        <table className="w-auto text-sm">
            <thead>
                <tr className="text-xs uppercase tracking-widest text-zinc-400 border-b border-zinc-200 dark:border-zinc-700">
                    ...
                    <th className="pb-2 pr-4 text-right">Q1</th>
                    <th className="pb-2 pr-4 text-right">Q2</th>
                    <th className="pb-2 text-right">Q3</th>
                </tr>
            </thead>
            <tbody>
                {results.map(entry => (
                    ...
                    >
                        ...
                        <td className="py-2 pr-4 text-right font-mono text-zinc-600 dark:text-zinc-300">{entry.q2}</td>
                        <td className="py-2 text-right font-mono text-zinc-600 dark:text-zinc-300">{entry.q3}</td>
                    </tr>
                ))}
            </tbody>
        </table>
